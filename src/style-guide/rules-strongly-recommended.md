...
বেশিরভাগ প্রোজেক্টে এই নিয়মগুলো কোডের পঠনযোগ্যতা এবং/অথবা ডেভেলপার অভিজ্ঞতা উন্নত করে বলে দেখা গেছে। আপনি এই নিয়মগুলো লঙ্ঘন করলেও আপনার কোড চলবে, কিন্তু এই ধরনের লঙ্ঘন বিরল এবং সুনির্দিষ্ট কারণযুক্ত হওয়া উচিত।
...
- যেহেতু এই উপাদানগুলো প্রায়শই ব্যবহৃত হয়, তাই আপনি হয়তো সব জায়গায় ইম্পোর্ট করার পরিবর্তে সেগুলোকে গ্লোবাল করে দিতে চাইতে পারেন। Vite-এ একটি প্রিফিক্স এটি সম্ভব করে তোলে:
...
দুর্ভাগ্যবশত, HTML কাস্টম এলিমেন্টগুলোকে সেলফ-ক্লোজিং হতে দেয় না - শুধুমাত্র [অফিসিয়াল "void" এলিমেন্টগুলোই](https://html.spec.whatwg.org/multipage/syntax.html#void-elements) তা পারে। এই কারণেই এই কৌশলটি কেবল তখনই সম্ভব যখন Vue-এর টেমপ্লেট কম্পাইলার DOM-এর আগে টেমপ্লেট পর্যন্ত পৌঁছাতে পারে এবং তারপর DOM স্পেক-সম্মত HTML পরিবেশন করতে পারে।
