...
:::tip পূর্বশর্ত
বাকি ডকুমেন্টেশন HTML, CSS, and JavaScript সাথে প্রাথমিক পরিচিতির আশা করে। আপনি যদি ফ্রন্টএন্ড ডেভেলপমেন্টে সম্পূর্ণ নতুন হয়ে থাকেন, তাহলে আপনার প্রথম ধাপ হিসেবে একটি ফ্রেমওয়ার্কের মধ্যে ঝাঁপিয়ে পড়া সেরা ধারণা নাও হতে পারে - মূল বিষয়গুলো আয়ত্ত্ব করুন এবং তারপরে ফিরে আসুন! আপনি [এই জাভাস্ক্রিপ্ট ওভারভিউ](https://developer.mozilla.org/en-US/docs/Web/JavaScript/A_re-introduction_to_JavaScript) দিয়ে আপনার জ্ঞানের পরীক্ষা করতে পারেন। অন্যান্য ফ্রেমওয়ার্কের সাথে পূর্বের অভিজ্ঞতা সাহায্য করে, কিন্তু একান্তই প্রয়োজনীয় না।
:::
