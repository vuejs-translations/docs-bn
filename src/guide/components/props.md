...
সংস্করণ 3.4 এবং নীচে, `foo` একটি প্রকৃত ধ্রুবক এবং কখনই পরিবর্তন হবে না। ভার্সন 3.5 এবং তার উপরে, Vue এর কম্পাইলার স্বয়ংক্রিয়ভাবে `props`কে প্রিপেন করে। যখন একই `<script setup>` ব্লকের কোড `defineProps` থেকে ধ্বংস করা ভেরিয়েবল অ্যাক্সেস করে। সুতরাং উপরের কোডটি নিম্নলিখিতগুলির সমতুল্য হয়ে যায়:
...
বাহ্যিক ফাংশন গেটারকে কল করতে পারে (অথবা এটিকে [toValue](/api/reactivity-utilities.html#tovalue)) দিয়ে যখন প্রদত্ত প্রপের পরিবর্তনগুলি ট্র্যাক করতে হবে, যেমন একটি গণনা করা বা প্রহরী গেটার মধ্যে.
