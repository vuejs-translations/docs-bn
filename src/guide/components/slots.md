...
নীচের উদাহরণে আমরা তিনটি শর্তসাপেক্ষ স্লট সহ একটি কার্ড কম্পোনেন্ট সংজ্ঞায়িত করি: `header`, `footer` এবং `default` একটি।
শিরোনাম/পাদলেখ/ডিফল্ট উপস্থিত থাকলে আমরা অতিরিক্ত স্টাইলিং প্রদানের জন্য সেগুলিকে মোড়ানো করতে চাই:
