...
এখানে উভয় <span v-pre>`{{ message  }}`</span> ইন্টারপোলেশন একই বিষয়অবজেক্ট রেন্ডার করবে।
...
নীচের উদাহরণে আমরা তিনটি শর্তসাপেক্ষ স্লট সহ একটি কার্ড উপাদান সংজ্ঞায়িত করি: `header`, `footer` এবং `default` একটি।
যখন শিরোনাম / পাদচরণ / ডিফল্টের জন্য বিষয়বস্তু উপস্থিত থাকে, আমরা অতিরিক্ত স্টাইলিং প্রদানের জন্য এটি মোড়ানো করতে চাই:
