...
যদি আপনি অন্যদের ব্যবহারের জন্য আপনার প্লাগইন তৈরি এবং প্রকাশ করতে চান, তাহলে [লাইব্রেরি মোডের উপর ভাইটের বিভাগ] (https://vite.dev/guide/build.html#library-mode) দেখুন।
