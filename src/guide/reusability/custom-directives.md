...
- `vnode`: অন্তর্নিহিত VNode আবদ্ধ কম্পোনেন্টের প্রতিনিধিত্ব করে।
- `prevNode`: VNode পূর্ববর্তী রেন্ডার থেকে আবদ্ধ কম্পোনেন্টের প্রতিনিধিত্ব করে। শুধুমাত্র `beforeUpdate` এবং `updated` হুকগুলিতে উপলব্ধ।
...
উপাদানগুলিতে ব্যবহৃত হলে, কাস্টম নির্দেশাবলী সর্বদা একটি কম্পোনেন্টের রুট নোডে প্রযোজ্য হবে, অনুরূপ[Fallthrough Attributes](/guide/components/attrs).
