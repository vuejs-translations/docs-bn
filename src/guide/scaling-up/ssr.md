...
Vite বিল্ট-ইন [Vue সার্ভার-সাইড রেন্ডারিংয়ের জন্য সমর্থন] প্রদান করে (https://vite.dev/guide/ssr.html), কিন্তু এটি ইচ্ছাকৃতভাবে নিম্ন-স্তরের। আপনি যদি সরাসরি Vite ব্যবহার করতে চান, তাহলে [vite-plugin-ssr](https://vite-plugin-ssr.com/) দেখুন, এটি একটি কমিউনিটি প্লাগইন যা আপনার জন্য অনেক চ্যালেঞ্জিং বিবরণ সারাংশ করে।
