...
1. `server.js` ফাইলে `server.use(express.static('.'))` যোগ করে ক্লায়েন্ট ফাইল পরিবেশন করুন।
2. HTML শেলে `<script type="module" src="/client.js"></script>` যোগ করে ক্লায়েন্ট এন্ট্রি লোড করুন।
3. HTML শেলে একটি [ইম্পোর্ট ম্যাপ](https://html.spec.whatwg.org/multipage/webappapis.html#import-maps) যোগ করে ব্রাউজারে `import * from 'vue'`-এর মতো ব্যবহার সমর্থন করুন।
...
এর একটি সম্পূর্ণ বাস্তবায়ন বেশ জটিল এবং এটি আপনার বেছে নেওয়া বিল্ড টুলচেইনের উপর নির্ভর করে। তাই, আপনার যদি SSR-এর প্রয়োজন হয়, তবে আমরা [Vue ফ্রেমওয়ার্ক](/guide/quick-start#frameworks) ব্যবহার করার জন্য জোরালোভাবে সুপারিশ করি, কারণ সেগুলিতে প্রায়শই বিল্ট-ইন SSR সাপোর্ট থাকে।
