...
- [Vitest](https://vitest.dev/)
  ...
  যেহেতু `create-vue` দ্বারা তৈরি অফিসিয়াল সেটআপটি [Vite](https://vite.dev/) এর উপর ভিত্তি করে তৈরি, তাই আমরা এমন একটি ইউনিট টেস্টিং ফ্রেমওয়ার্ক ব্যবহার করার পরামর্শ দিচ্ছি যা Vite থেকে সরাসরি একই কনফিগারেশন ব্যবহার করে পাইপলাইন রূপান্তর করতে পারে। [Vitest](https://vitest.dev/) হল একটি ইউনিট টেস্টিং ফ্রেমওয়ার্ক যা বিশেষভাবে এই উদ্দেশ্যে ডিজাইন করা হয়েছে, যা Vue/Vite টিম সদস্যদের দ্বারা তৈরি এবং রক্ষণাবেক্ষণ করা হয়। এটি ন্যূনতম প্রচেষ্টার সাথে Vite-ভিত্তিক প্রকল্পগুলির সাথে একীভূত হয় এবং দ্রুত গতিতে কাজ করে।
...
> আপনার সফ্টওয়্যার ব্যবহারের সাথে আপনার পরীক্ষাগুলি যত বেশি সাদৃশ্যপূর্ণ হবে, তত বেশি আত্মবিশ্বাস আপনাকে দেবে। - [কেন্ট সি. ডডস](https://x.com/kentcdodds/status/977018512689455106) - টেস্টিং লাইব্রেরির লেখক
