...
পূর্বে উল্লিখিত হিসাবে, ইউনিট পরীক্ষা সাধারণত স্বয়ংসম্পূর্ণ ব্যবসায়িক যুক্তি, কম্পোনেন্ট, ক্লাস, মডিউল বা ফাংশনগুলিতে প্রয়োগ করা হয় যা UI রেন্ডারিং, নেটওয়ার্ক অনুরোধ, বা অন্যান্য পরিবেশগত উদ্বেগ জড়িত নয়।
...
- [Cypress](https://www.cypress.io/)
  ...
  সামগ্রিকভাবে, আমরা বিশ্বাস করি সাইপ্রেস একটি তথ্যপূর্ণ গ্রাফিকাল ইন্টারফেস, চমৎকার ডিবাগবিলিটি, অন্তর্নির্মিত দাবী, স্টাব, ফ্লেক-প্রতিরোধ, সমান্তরালকরণ এবং স্ন্যাপশটগুলির মতো বৈশিষ্ট্য সহ সবচেয়ে সম্পূর্ণ E2E সমাধান প্রদান করে। উপরে উল্লিখিত হিসাবে, এটি [কম্পোনেন্ট টেস্টিং](https://docs.cypress.io/guides/component-testing/introduction) এর জন্যও সহায়তা প্রদান করে। এটি ক্রোমিয়াম-ভিত্তিক ব্রাউজার, ফায়ারফক্স এবং ইলেক্ট্রন সমর্থন করে। WebKit সমর্থন উপলব্ধ, কিন্তু পরীক্ষামূলক চিহ্নিত করা হয়েছে৷

### Other Options {#other-options-2}

- [Playwright](https://playwright.dev/) একটি দুর্দান্ত E2E পরীক্ষার সমাধান যা Chromium, WebKit এবং Firefox সহ সমস্ত আধুনিক রেন্ডারিং ইঞ্জিনকে সমর্থন করে৷ Windows, Linux, এবং macOS-এ স্থানীয়ভাবে বা CI-তে, হেডলেস বা Android এবং মোবাইল Safari-এর জন্য Google Chrome-এর নেটিভ মোবাইল এমুলেশনের সাহায্যে পরীক্ষা করুন।

- [Nightwatch](https://nightwatchjs.org/) হল একটি E2E টেস্টিং সলিউশন যা [Selenium WebDriver](https://www.npmjs.com/package/selenium-webdriver) এর উপর ভিত্তি করে। এটি এটিকে নেটিভ মোবাইল টেস্টিং সহ বিস্তৃত ব্রাউজার সমর্থন পরিসর দেয়। সেলেনিয়াম-ভিত্তিক সমাধানগুলি Playwright বা সাইপ্রেসের চেয়ে ধীর হবে।
