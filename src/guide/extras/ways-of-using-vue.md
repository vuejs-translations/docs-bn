...
এছাড়াও উচ্চ স্তরের [Vue ফ্রেমওয়ার্ক](/guide/quick-start#frameworks) রয়েছে, যেগুলো এই প্যারাডাইমের উপর ভিত্তি করে তৈরি এবং ফুল স্ট্যাক অ্যাপ্লিকেশন ডেভেলপ করার জন্য SSR-এর বিল্ট-ইন সাপোর্ট প্রদান করে।
...
Vue টিম [VitePress](https://vitepress.dev/) নামে একটি স্ট্যাটিক-সাইট জেনারেটর রক্ষণাবেক্ষণ করে, যা এই মুহূর্তে আপনার পড়া ওয়েবসাইটটিকে চালনা করছে এবং SSG-এর উভয় সংস্করণই সমর্থন করে! এছাড়াও, অন্যান্য [Vue ফ্রেমওয়ার্কগুলো](/guide/quick-start#frameworks) দেখে নিতে ভুলবেন না, যেগুলো সাধারণত SSG সমর্থন করে।
