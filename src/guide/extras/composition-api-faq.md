...
আপনি যদি একচেটিয়াভাবে কম্পোজিশন API (উপরে তালিকাভুক্ত options সাথে) ব্যবহার করতে চান তবে আপনি একটি [কম্পাইল-টাইম ফ্ল্যাগ](/api/compile-time-flags) এর মাধ্যমে আপনার প্রোডাকশন বান্ডেল থেকে কয়েক কেবিএস শেভ করতে পারেন যা Vue থেকে Options API সম্পর্কিত কোড ড্রপ করে। মনে রাখবেন এটি আপনার নির্ভরতার Vue উপাদানগুলিকেও প্রভাবিত করে।
