...
Vue একটি HTML-ভিত্তিক টেমপ্লেট সিনট্যাক্স ব্যবহার করে যা আপনাকে রেন্ডার করা DOM-কে অন্তর্নিহিত উপাদানের ইনস্ট্যান্সের ডেটার সাথে ঘোষণামূলকভাবে আবদ্ধ করতে দেয়। সমস্ত Vue টেমপ্লেট সিনট্যাক্সগতভাবে বৈধ HTML যা স্পেক-সম্মত ব্রাউজার এবং HTML পার্সার দ্বারা পার্স করা যেতে পারে।
...
যদি অ্যাট্রিবিউটের নাম জাভাস্ক্রিপ্ট ভ্যালুর ভেরিয়েবল নামের সাথে একই হয়, তাহলে সিনট্যাক্সকে আরও ছোট করে অ্যাট্রিবিউট ভ্যালু বাদ দেওয়া যেতে পারে:
...
এখানে, `v-if` নির্দেশিকা `দেখা` অভিব্যক্তির মানের সত্যতার উপর ভিত্তি করে `<p>` কম্পোনেন্টটিকে সরিয়ে দেবে বা সন্নিবেশ করবে।
