...
আপনি একটি অবজেক্টর বৈশিষ্ট্যের মাধ্যমে পুনরাবৃত্তি করতে `v-for` ব্যবহার করতে পারেন। পুনরাবৃত্তির ক্রম অবজেক্টে `Object.keys()` কল করার ফলাফলের উপর ভিত্তি করে করা হবে:
...
:::tip বিঃদ্রঃ
`key` এখানে `v-bind` এর সাথে আবদ্ধ একটি বিশেষ বৈশিষ্ট্য। এটি প্রপার্টি কী ভেরিয়েবলের সাথে বিভ্রান্ত হওয়া উচিত নয় যখন [কোন অবজেক্টর সাথে `v-for` ব্যবহার করে](#v-for-with-an-object)।
:::

[এটি সুপারিশ করা হয়](/style-guide/rules-essential#use-keyed-v-for) যখনই সম্ভব `v-for` এর সাথে একটি `key` বৈশিষ্ট্য প্রদান করা, যদি না পুনরাবৃত্তি করা DOM বিষয়অবজেক্ট সহজ হয় (যেমন কোনো কম্পোনেন্ট বা রাষ্ট্রীয় DOM কম্পোনেন্ট), অথবা আপনি ইচ্ছাকৃতভাবে কর্মক্ষমতা লাভের জন্য ডিফল্ট আচরণের উপর নির্ভর করছেন।

`key` বাইন্ডিং আদিম মান আশা করে - যেমন স্ট্রিং এবং সংখ্যা। অবজেক্টকে `v-for` কী হিসেবে ব্যবহার করবেন না। `key` অ্যাট্রিবিউটের বিস্তারিত ব্যবহারের জন্য, অনুগ্রহ করে [`key` API ডকুমেন্টেশন](/api/built-in-special-attributes#key) দেখুন।
...
কখনও কখনও আমরা আসল ডেটা পরিবর্তন বা রিসেট না করে একটি অ্যারের ফিল্টার করা বা সাজানো সংস্করণ প্রদর্শন করতে চাই। এই ক্ষেত্রে, আপনি একটি গণনাকৃত কম্পিউটেড প্রপার্টি তৈরি করতে পারেন যা ফিল্টার করা বা সাজানো অ্যারে প্রদান করে।
...
একটি গণনাকৃত কম্পিউটেড প্রপার্টিতে `reverse()` এবং `sort()` এর সাথে সতর্ক থাকুন! এই দুটি পদ্ধতি মূল অ্যারেকে রূপান্তরিত করবে, যা গণিত গেটারগুলিতে এড়ানো উচিত। এই পদ্ধতিগুলি কল করার আগে মূল অ্যারের একটি অনুলিপি তৈরি করুন:
