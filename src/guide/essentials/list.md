...
যখনই সম্ভব `v-for` সহ একটি `key` বৈশিষ্ট্য প্রদান করার পরামর্শ দেওয়া হয়, যদি না পুনরাবৃত্তি করা DOM বিষয়বস্তু সহজ হয় (যেমন কোনো উপাদান বা রাষ্ট্রীয় DOM উপাদান নেই) অথবা আপনি ইচ্ছাকৃতভাবে কর্মক্ষমতা লাভের জন্য ডিফল্ট আচরণের উপর নির্ভর করছেন।
