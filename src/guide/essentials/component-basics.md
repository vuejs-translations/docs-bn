...
কম্পোনেন্টগুলি আমাদের UI কে স্বাধীন এবং পুনঃব্যবহারযোগ্য টুকরোগুলিতে বিভক্ত করার অনুমতি দেয় এবং প্রতিটি অংশকে বিচ্ছিন্নভাবে চিন্তা করতে দেয়৷ একটি অ্যাপকে নেস্টেড কম্পোনেন্টগুলির একটি গাছে সংগঠিত করা সাধারণ:

![Component Tree](./images/components.png)

<!-- https://www.figma.com/file/qa7WHDQRWuEZNRs7iZRZSI/components -->

এটি আমরা যেভাবে নেটিভ HTML কম্পোনেন্টগুলিকে নেস্ট করি তার সাথে খুব মিল, তবে Vue তার নিজস্ব কম্পোনেন্ট মডেল প্রয়োগ করে যা আমাদের প্রতিটি কম্পোনেন্টে কাস্টম বিষয়বস্তু এবং যুক্তি এনক্যাপসুলেট করতে দেয়। Vue নেটিভ ওয়েব কম্পোনেন্টের সাথেও সুন্দরভাবে খেলে। আপনি যদি Vue কম্পোনেন্ট এবং নেটিভ ওয়েব কম্পোনেন্টগুলির মধ্যে সম্পর্ক সম্পর্কে আগ্রহী হন, [এখানে আরও পড়ুন](/guide/extras/web-components)।
...
:::tip
আমরা এই গাইডের বাকি অংশের জন্য SFC সিনট্যাক্স ব্যবহার করব - আপনি একটি বিল্ড স্টেপ ব্যবহার করছেন বা না করছেন তা নির্বিশেষে কম্পোনেন্টগুলির চারপাশের ধারণাগুলি একই। [Examples](/examples/) বিভাগটি উভয় পরিস্থিতিতেই কম্পোনেন্টের ব্যবহার দেখায়।
:::
...
এটি আমদানি না করেই একটি প্রদত্ত অ্যাপের সমস্ত কম্পোনেন্টের জন্য উপলব্ধ করে, বিশ্বব্যাপী একটি কম্পোনেন্ট নিবন্ধন করাও সম্ভব। গ্লোবাল বনাম স্থানীয় রেজিস্ট্রেশনের ভালো-মন্দ আলোচনা করা হয়েছে ডেডিকেটেড [ কম্পোনেন্ট রেজিস্ট্রেশন](/guide/components/registration) বিভাগে।

কম্পোনেন্টগুলি আপনি যতবার চান ততবার পুনরায় ব্যবহার করা যেতে পারে:
...
আরও বিশদ বিবরণের জন্য [in-DOM template parsing caveats](#in-dom-template-parsing-caveats) দেখুন।
...
প্রপগুলি হল কাস্টম বৈশিষ্ট্যগুলি যা আপনি একটি কম্পোনেন্টে নিবন্ধন করতে পারেন। আমাদের ব্লগ পোস্ট কম্পোনেন্টে একটি শিরোনাম পাস করার জন্য, <span class="options-api">[`props`](/api/options-state#props) ব্যবহার করে এই কম্পোনেন্টটি গ্রহণ করে এমন প্রপসের তালিকায় আমাদের এটি ঘোষণা করতে হবে। বিকল্প</span><span class="composition-api">[`defineProps`](/api/sfc-script-setup#defineprops-defineemits) ম্যাক্রো</span>:
...
লক্ষ্য করুন কিভাবে [`v-bind` সিনট্যাক্স](/api/built-in-directives#v-bind) (`:title="post.title"`) ডায়নামিক প্রপ মান পাস করতে ব্যবহৃত হয়। এটি বিশেষভাবে উপযোগী যখন আপনি সঠিক বিষয়বস্তু জানেন না যে আপনি সময়ের আগে রেন্ডার করতে যাচ্ছেন।

আপাতত প্রপস সম্পর্কে আপনার এতটুকুই জানা দরকার, কিন্তু একবার আপনি এই পৃষ্ঠাটি পড়া শেষ করে এবং এর বিষয়অবজেক্টতে স্বাচ্ছন্দ্য বোধ করলে, আমরা [প্রপস](/guide/components/props) এর সম্পূর্ণ নির্দেশিকা পড়তে পরে ফিরে আসার পরামর্শ দিই।

## Listening to Events {#listening-to-events}

যেহেতু আমরা আমাদের `<BlogPost>` কম্পোনেন্টটি ডেভেলপমেন্ট করি, কিছু বৈশিষ্ট্যের জন্য অভিভাবকের সাথে ব্যাক আপ যোগাযোগের প্রয়োজন হতে পারে। উদাহরণস্বরূপ, আমরা পৃষ্ঠার বাকি অংশটিকে ডিফল্ট আকারে রেখে ব্লগ পোস্টের পাঠ্যকে বড় করার জন্য একটি অ্যাক্সেসিবিলিটি বৈশিষ্ট্য অন্তর্ভুক্ত করার সিদ্ধান্ত নিতে পারি।
...
এটি সমস্ত ইভেন্টগুলিকে নথিভুক্ত করে যা একটি কম্পোনেন্ট নির্গত করে এবং ঐচ্ছিকভাবে [তাদের যাচাই করে](/guide/components/events#events-validation)। এটি Vue-কে  চাইল্ড কম্পোনেন্টের মূল কম্পোনেন্টে নেটিভ শ্রোতা হিসাবে প্রয়োগ করা এড়াতেও অনুমতি দেয়।
...
আপাতত স্লট সম্পর্কে আপনার এতটুকুই জানা দরকার, কিন্তু একবার আপনি এই পৃষ্ঠাটি পড়া শেষ করে এবং এর বিষয়অবজেক্টতে স্বাচ্ছন্দ্য বোধ করলে, আমরা [Slots](/guide/components/slots) এর সম্পূর্ণ নির্দেশিকা পড়তে পরে ফিরে আসার পরামর্শ দিই।
...
`<component :is="...">` দিয়ে একাধিক কম্পোনেন্টের মধ্যে স্যুইচ করার সময়, একটি কম্পোনেন্ট আনমাউন্ট করা হবে যখন এটি থেকে সুইচ করা হবে। আমরা বিল্ট-ইন [`<KeepAlive>` কম্পোনেন্ট](/guide/built-ins/keep-alive) দিয়ে নিষ্ক্রিয় কম্পোনেন্টগুলিকে "জীবিত" থাকতে বাধ্য করতে পারি।
...
এর কারণ হল HTML স্পেক শুধুমাত্র [কিছু নির্দিষ্ট কম্পোনেন্ট](https://html.spec.whatwg.org/multipage/syntax.html#void-elements) ক্লোজিং ট্যাগগুলিকে বাদ দেওয়ার অনুমতি দেয়, সবচেয়ে সাধারণ হল `<input> ` এবং `<img>`। অন্য সব কম্পোনেন্টের জন্য, আপনি যদি ক্লোজিং ট্যাগটি বাদ দেন, তাহলে নেটিভ HTML পার্সার মনে করবে আপনি কখনই ওপেনিং ট্যাগটি বন্ধ করেননি। উদাহরণস্বরূপ, নিম্নলিখিত স্নিপেট:
...
কাস্টম কম্পোনেন্ট `<blog-post-row>` অবৈধ বিষয়অবজেক্ট হিসাবে উত্তোলন করা হবে, যার ফলে চূড়ান্ত রেন্ডার করা আউটপুটে ত্রুটি দেখা দিবে। আমরা একটি সমাধান হিসাবে বিশেষ [`is` বৈশিষ্ট্য](/api/built-in-special-attributes#is) ব্যবহার করতে পারি:
...
:::tip
যখন নেটিভ এইচটিএমএল কম্পোনেন্টগুলিতে ব্যবহার করা হয়, তখন একটি Vue কম্পোনেন্ট হিসাবে ব্যাখ্যা করার জন্য `is` এর মান অবশ্যই `vue:` এর সাথে প্রিফিক্স করা উচিত। স্থানীয় [কাস্টমাইজড বিল্ট-ইন elements](https://html.spec.whatwg.org/multipage/custom-elements.html#custom-elements-customized-builtin-example) নিয়ে বিভ্রান্তি এড়াতে এটি প্রয়োজন।
:::

এখনকার জন্য ইন-ডোম টেমপ্লেট পার্সিং সতর্কতা সম্পর্কে আপনার এতটুকুই জানা দরকার - এবং আসলে, Vue এর _Essentials_ এর শেষ। অভিনন্দন! শেখার জন্য এখনও আরও অনেক কিছু আছে, কিন্তু প্রথমে, আমরা Vue এর সাথে অনুশীলন করা জন্য বিরতি নেওয়ার পরামর্শ দিই - মজাদার কিছু তৈরি করুন, অথবা আপনি যদি ইতিমধ্যে না করে থাকেন তবে কিছু [Examples](/examples/) দেখুন।
