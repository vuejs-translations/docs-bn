...
- **পেজ লোড পারফরম্যান্স**: অ্যাপ্লিকেশনটি কত দ্রুত কন্টেন্ট দেখায় এবং প্রাথমিক ভিজিটে ইন্টারেক্টিভ হয়ে ওঠে। এটি সাধারণত [Largest Contentful Paint (LCP)](https://web.dev/lcp/) এবং [Interaction to Next Paint](https://web.dev/articles/inp) এর মতো ওয়েব গুরুত্বপূর্ণ মেট্রিক্স ব্যবহার করে পরিমাপ করা হয়।
...
- সম্ভব হলে একটি বিল্ড স্টেপ ব্যবহার করুন।
  ...
  - একটি বিল্ড স্টেপ ব্যবহার করার সময়, টেমপ্লেটগুলি আগে থেকে কম্পাইল করা হয় তাই আমাদের ব্রাউজারে Vue কম্পাইলার পাঠাতে হবে না। এটি **14kb** min+gzipped JavaScript বাঁচায় এবং রানটাইম সংকলন ব্যয় এড়ায়।
...
Vue 3.4 এবং তার উপরে, একটি গণনা করা সম্পত্তি শুধুমাত্র প্রভাব ট্রিগার করবে যখন এর গণনা করা মান আগের থেকে পরিবর্তিত হবে। উদাহরণ স্বরূপ, নিম্নোক্ত `isEven` গণনা করা শুধুমাত্র প্রভাবগুলিকে ট্রিগার করে যদি প্রত্যাবর্তিত মান `true` থেকে `false` তে পরিবর্তিত হয়, বা বিপরীতে:
...
যেহেতু প্রতিবার একটি নতুন অবজেক্ট তৈরি হয়, নতুন মান প্রযুক্তিগতভাবে সর্বদা পুরানো মান থেকে আলাদা। এমনকি যদি `isEven` প্রপার্টি একই থাকে, Vue জানতে পারবে না যদি না এটি পুরানো মান এবং নতুন মানের গভীর তুলনা করে। এই ধরনের তুলনা ব্যয়বহুল হতে পারে এবং সম্ভবত এটি মূল্যবান নয়।
