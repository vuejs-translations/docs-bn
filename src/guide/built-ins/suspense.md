...
`<Suspense>` একটি সীমানা তৈরি করে যা গাছের নিচের সমস্ত অ্যাসিঙ্ক কম্পোনেন্টগুলির সমাধান করবে,
প্রত্যাশিত. যাইহোক, যখন আমরা `DynamicAsyncOuter` পরিবর্তন করি, `<Suspense>` সঠিকভাবে এটির জন্য অপেক্ষা করে, কিন্তু যখন আমরা `DynamicAsyncInner` পরিবর্তন করি,
নেস্ট করা `DynamicAsyncInner` একটি খালি নোড রেন্ডার করে যতক্ষণ না এটি সমাধান করা হয় (আগের একটি বা ফলব্যাক স্লটের পরিবর্তে)।
...
আপনি যদি `suspensible` প্রপ সেট না করেন, তাহলে অভ্যন্তরীণ `<Suspense>`টিকে প্যারেন্ট `<Suspense>` দ্বারা একটি সিঙ্ক কম্পোনেন্টের মতো বিবেচনা করা হবে।
এর মানে হল যে এটির নিজস্ব ফলব্যাক স্লট রয়েছে এবং যদি উভয় `ডাইনামিক` কম্পোনেন্ট একই সময়ে পরিবর্তিত হয়,
শিশু `<Suspense>` তার নিজস্ব নির্ভরতা ট্রি লোড করার সময় খালি নোড এবং একাধিক প্যাচিং চক্র থাকতে পারে,
যা কাম্য নাও হতে পারে। এটি সেট করা হলে, সমস্ত অ্যাসিঙ্ক নির্ভরতা হ্যান্ডলিং প্যারেন্ট `<Suspense>`কে দেওয়া হয় (নিঃসৃত ইভেন্টগুলি সহ)
এবং অভ্যন্তরীণ `<Suspense>` নির্ভরতা রেজোলিউশন এবং প্যাচিংয়ের জন্য সম্পূর্ণরূপে অন্য সীমানা হিসাবে কাজ করে।
