...
এই ধরনের ক্ষেত্রে আপনি `<Transition>` কম্পোনেন্টের `duration` প্রপ ব্যবহার করে একটি স্পষ্ট ট্রানজিশন সময়কাল (মিলিসেকেন্ডে) নির্দিষ্ট করতে পারেন। মোট সময়কাল অভ্যন্তরীণ উপাদানের বিলম্ব এবং ট্রানজিশন সময়কালের সাথে মিলিত হওয়া উচিত:
...
আপনি লক্ষ্য করতে পারেন যে উপরে দেখানো অ্যানিমেশনগুলি বেশিরভাগই `transform` এবং `opacity` এর মতো বৈশিষ্ট্য ব্যবহার করছে। এই বৈশিষ্ট্যগুলি অ্যানিমেট করার জন্য দক্ষ কারণ:
...
তুলনামূলকভাবে, `height` বা  `margin` এর মতো বৈশিষ্ট্যগুলি CSS লেআউটকে ট্রিগার করবে, তাই এগুলি অ্যানিমেট করার জন্য অনেক বেশি ব্যয়বহুল, এবং সতর্কতার সাথে ব্যবহার করা উচিত।
...
অ্যানিমেশনগুলি সম্পাদন করার জন্য [GSAP লাইব্রেরি](https://gsap.com/) ব্যবহার করে এখানে একটি ডেমো রয়েছে৷ আপনি অবশ্যই অন্য যেকোনো অ্যানিমেশন লাইব্রেরি ব্যবহার করতে পারেন, যেমন [Anime.js](https://animejs.com/) বা [মোশন ওয়ান](https://motion.dev/):
...
কখনও কখনও একটি পরিবর্তন ঘটানোর জন্য আপনাকে একটি DOM কম্পোনেন্টস পুনরায় রেন্ডার করতে বাধ্য করতে হবে৷

উদাহরণস্বরূপ এই কাউন্টার কম্পোনেন্টটি নিন:
...
যদি আমরা `key` অ্যাট্রিবিউটটি বাদ দিতাম, তবে শুধুমাত্র টেক্সট নোড আপডেট করা হবে এবং এইভাবে কোনো রূপান্তর ঘটবে না। যাইহোক, 'কী' অ্যাট্রিবিউটের জায়গায়, Vue একটি নতুন `span` কম্পোনেন্ট তৈরি করতে জানে যখনই `count` পরিবর্তিত হয় এবং এইভাবে `Transition` কম্পোনেন্টটির মধ্যে স্থানান্তরের জন্য ২টি ভিন্ন কম্পোনেন্ট থাকে।
