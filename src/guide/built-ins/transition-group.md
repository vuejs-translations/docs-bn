...
`<TransitionGroup>` হল একটি অন্তর্নির্মিত উপাদান যা একটি তালিকায় রেন্ডার করা উপাদান বা উপাদানগুলির সন্নিবেশ, অপসারণ এবং অর্ডার পরিবর্তন অ্যানিমেট করার জন্য ডিজাইন করা হয়েছে।
...
- ডিফল্টরূপে, এটি একটি মোড়ক উপাদান রেন্ডার করে না। কিন্তু আপনি `tag` প্রপের সাথে রেন্ডার করার জন্য একটি উপাদান নির্দিষ্ট করতে পারেন।

- [Transition modes](./transition#transition-modes) উপলভ্য নয়, কারণ আমরা আর পারস্পরিক একচেটিয়া উপাদানগুলির মধ্যে পরিবর্তন করছি না।

- ভিতরের উপাদানগুলির একটি অনন্য `key` বৈশিষ্ট্য থাকতে **সর্বদা প্রয়োজন**।
...
```css{1,13-17}
.list-move, /* চলমান উপাদানগুলিতে রূপান্তর প্রয়োগ করুন */
.list-enter-active,
.list-leave-active {
  transition: all 0.5s ease;
}
...
তারপর, জাভাস্ক্রিপ্ট হুকগুলিতে, আমরা ডেটা অ্যাট্রিবিউটের উপর ভিত্তি করে একটি বিলম্ব সহ উপাদানটিকে অ্যানিমেট করি। এই উদাহরণটি অ্যানিমেশন করতে [GreenSock লাইব্রেরি](https://greensock.com/) ব্যবহার করছে:
