...
:::tip
`<Teleport>` কম্পোনেন্টটি মাউন্ট হওয়ার সময় টেলিপোর্টের টার্গেটটি অবশ্যই DOM-এ আগে থেকেই থাকতে হবে। আদর্শগতভাবে, এটি সম্পূর্ণ Vue অ্যাপ্লিকেশনের বাইরের একটি এলিমেন্ট হওয়া উচিত। যদি Vue দ্বারা রেন্ডার করা অন্য কোনো এলিমেন্টকে টার্গেট করা হয়, তবে আপনাকে নিশ্চিত করতে হবে যে `<Teleport>`-এর আগে সেই এলিমেন্টটি মাউন্ট হয়েছে। আপনি যদি SSR ব্যবহার করেন, তাহলে [Handling Teleports in SSR](/guide/scaling-up/ssr#teleports) দেখুন।
:::
