...
- **গ্লোবাল স্পেশাল স্পনসর**:

- বিশ্বব্যাপী **একজন** স্পনসরের জন্য সীমাবদ্ধ। <span v-if="!data?.special">বর্তমানে খালি। [যোগাযোগ করুন](mailto:sponsor@vuejs.org?subject=Vue.js%20special%20sponsor%20inquiry)!</span><span v-else>(বর্তমানে পূরণকৃত)</span>

- (এক্সক্লুসিভ) [vuejs.org](/) এর প্রথম পৃষ্ঠায় **উপরের দিকে** লোগো স্থাপনের সুযোগ।

- (এক্সক্লুসিভ) [Vue-এর অফিসিয়াল X অ্যাকাউন্ট](https://x.com/vuejs) (৩২০ হাজার ফলোয়ার) এর মাধ্যমে প্রধান প্রোডাক্ট লঞ্চের বিশেষ ঘোষণা এবং নিয়মিত রিটুইট।

- নিচের স্তরগুলো থেকে সমস্ত স্থানে সবচেয়ে সুস্পষ্ট লোগো স্থাপনের সুযোগ। - **প্ল্যাটিনাম (USD$2,000/মাস)**:

- [vuejs.org](/) এর প্রথম পাতায় লোগোর সুস্পষ্ট স্থান।

- সমস্ত কন্টেন্ট পেজের সাইডবারে লোগোর সুস্পষ্ট স্থান।

- [`vuejs/core`](https://github.com/vuejs/core) এবং [`vuejs/vue`](https://github.com/vuejs/vue) এর README ফাইলে লোগোর সুস্পষ্ট স্থান।


- **গোল্ড (USD$500/মাস)**:


- [vuejs.org](/) এর প্রথম পাতায় বড় আকারে লোগোর স্থান।

- `vuejs/core` এবং `vuejs/vue` এর README ফাইলে বড় আকারে লোগোর স্থান।

- **সিলভার (USD$250/মাস)**:

- `vuejs/core` এবং `vuejs/vue` এর `BACKERS.md` ফাইলে মাঝারি আকারে লোগোর স্থান। - **ব্রোঞ্জ (USD$100/মাস)**:

- `vuejs/core` এবং `vuejs/vue`-এর `BACKERS.md` ফাইলে ছোট লোগো প্রদর্শনের সুযোগ।

- **উদার সমর্থক (USD$50/মাস)**:


- `vuejs/core` এবং `vuejs/vue`-এর `BACKERS.md` ফাইলে অন্যান্য স্বতন্ত্র সমর্থকদের উপরে আপনার নাম তালিকাভুক্ত করা হবে।

- **স্বতন্ত্র সমর্থক (USD$5/মাস)**:


- `vuejs/core` এবং `vuejs/vue`-এর `BACKERS.md` ফাইলে আপনার নাম তালিকাভুক্ত করা হবে।
