...
- টাইপ ডিক্লেয়ারেশন ব্যবহার করার সময়, ডবল ডিক্লেয়ারেশনের প্রয়োজনীয়তা দূর করতে এবং সঠিক রানটাইম বেহ্যিভিয়ার নিশ্চিত করতে স্ট্যাটিক বিশ্লেষণ থেকে সমতুল্য রানটাইম ঘোষণা স্বয়ংক্রিয়ভাবে তৈরি হয়।
  ...
  - ডেভ মোডে, কম্পাইলার টাইপগুলি থেকে সংশ্লিষ্ট রানটাইম বৈধতা অনুমান করার চেষ্টা করবে। উদাহরণস্বরূপ, এখানে `foo: String` `foo: string` টাইপ থেকে অনুমান করা হয়েছে। আমদানি করা টাইপগুলিও সমাধান করা হয়, যদি টাইপস্ক্রিপ্টটি পিয়ার ডিপেন্ডেন্সি হিসাবে ইনস্টল করা থাকে।
...
- সংস্করণ 3.2 এবং নীচে, `defineProps()`-এর জন্য জেনেরিক টাইপ প্যারামিটার একটি লিটারাল টাইপ বা লোকাল ইন্টারফেসের একটি রেফারেন্সের মধ্যে সীমাবদ্ধ ছিল।
  ...
  এই সীমাবদ্ধতাটি 3.3-এ সমাধান করা হয়েছে। Vue-এর সর্বশেষ সংস্করণটি আমদানি করা রেফারেন্সিং এবং টাইপ প্যারামিটার পজিশনে সীমিত জটিল ধরণের সেট সমর্থন করে। তবে, যেহেতু টাইপ থেকে রানটাইম রূপান্তর এখনও AST-ভিত্তিক, কিছু জটিল ধরণের জন্য যার প্রকৃত টাইপ বিশ্লেষণ প্রয়োজন, যেমন শর্তসাপেক্ষ প্রকার, সমর্থিত নয়। আপনি একটি একক প্রপের ধরণের জন্য শর্তসাপেক্ষ প্রকার ব্যবহার করতে পারেন, কিন্তু সম্পূর্ণ প্রপস অবজেক্টের জন্য নয়।
