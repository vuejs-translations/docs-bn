...
একটি [গেটার ফাংশন](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Functions/set#description) নেয় এবং একটি পঠনযোগ্য প্রতিক্রিয়াশীল [ref](#ref) অবজেক্ট প্রদান করে গেটার থেকে ফিরে মান. এটি একটি লিখনযোগ্য রেফ অবজেক্ট তৈরি করতে `get` এবং `set` ফাংশন সহ একটি অবজেক্টও নিতে পারে।
