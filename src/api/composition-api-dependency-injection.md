...
- **Details**
  ...
  প্রথম যুক্তি হল ইনজেকশন কী। Vue একটি ম্যাচিং কী সহ একটি প্রদত্ত মান সনাক্ত করার জন্য প্যারেন্ট চেইনের উপরে চলে যাবে। যদি প্যারেন্ট চেইনের একাধিক উপাদান একই কী সরবরাহ করে, তাহলে ইনজেকশন উপাদানের সবচেয়ে কাছেরটি চেইনের উপরের অংশগুলিকে "ছায়া" দেবে এবং এর মান ব্যবহার করা হবে। যদি ম্যাচিং কী সহ কোনও মান পাওয়া না যায়, তাহলে `inject()` `undefined` প্রদান করে যদি না একটি ডিফল্ট মান সরবরাহ করা হয়।
