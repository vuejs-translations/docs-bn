...
মাইনর এবং মেজর রিলিজ সাধারণত কয়েকটি প্রি-রিলিজ পর্যায়ের মধ্য দিয়ে যায়: **আলফা**, **বিটা**, এবং **রিলিজ ক্যান্ডিডেট (RC)**। প্রি-রিলিজের সংখ্যা এবং ধরন পরিবর্তনের পরিধির উপর নির্ভর করে। উদাহরণস্বরূপ, সীমিত আপডেটসহ একটি মাইনর রিলিজে শুধুমাত্র একটি বিটা পর্যায় থাকতে পারে, যেখানে একটি মেজর রিলিজে পুঙ্খানুপুঙ্খ পরীক্ষা এবং কমিউনিটির মতামতের জন্য সাধারণত তিনটি পর্যায়ই অন্তর্ভুক্ত থাকে।

আপনি `npx install-vue@alpha`, `npx install-vue@beta`, অথবা `npx install-vue@rc` ব্যবহার করে npm থেকে সর্বশেষ প্রি-রিলিজগুলো ইনস্টল করতে পারেন। ট্যাগ করা প্রি-রিলিজগুলোতে এখনো অন্তর্ভুক্ত হয়নি এমন পরিবর্তনগুলো পরীক্ষা করার জন্য, [vuejs/core](https://github.com/vuejs/core) রিপোজিটরির প্রতিটি কমিট একটি অস্থায়ী কন্টিনিউয়াস-রিলিজ প্রিভিউ হিসেবে প্রকাশ করা হয়, যা আপনি `npx install-vue@edge` ব্যবহার করে ইনস্টল করতে পারেন।
