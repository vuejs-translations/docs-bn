...
<template>
  ...
  <section id="highlights" class="vt-box-container">
    <div class="vt-box">
      <h2>সাদৃশ্যপূর্ণ</h2>
      <p>
        একটি সমৃদ্ধ, পর্যায়ক্রমে গ্রহণীয় ইকোসিস্টেম যা একটি লাইব্রেরি থেকে একটি পূর্ণাঙ্গ ফ্রেমওয়ার্ক পর্যন্ত বিস্তৃত।
      </p>
    </div>
    <div class="vt-box">
      <h2>ব্যবহারকারী-বান্ধব</h2>
      <p>
    ...
    <div class="vt-box">
      <h2>স্কেলে‌বল</h2>
      <p>
        রিএক্টিভ, কম্পাইলার-অপ্টিমাইজড রেন্ডারিং সিস্টেম যা খুব কমই ম্যানুয়াল অপ্টিমাইজেশনের প্রয়োজন হয়।
      </p>
    </div>
  </section>
